...
def move_motors(x, y):
    ...
    #x_to_arduino = '<Jx{}>'.format(x)
    #y_to_arduino = '<Jy{}>'.format(y)
    ...
    ser2.write(x_to_arduino + x_to_arduino)
...
position_label = tk.Label(middle_frame, text = 'position (steps)', font = myFont)
