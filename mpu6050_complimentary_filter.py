# source: https://github.com/MarkSherstan/MPU-6050-9250-I2C-CompFilter/blob/master/RPi/main.py
...
class MPU:
    ...
    def getRawData(self):
        ...
        # print("\tax: " + str(round(self.ax,1)))
        # print("\tay: " + str(round(self.ay,1)))
        # print("\taz: " + str(round(self.az,1)))
